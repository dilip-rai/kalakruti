...
class SK_API Sk2DPathEffect :

public SkPathEffect {
public:

bool filterPath(SkPath *, const SkPath &, SkStrokeRec *, const SkRect *)
...
void nextSpan(int u, int v, int ucount, SkPath *)
...
void next(const SkPoint &, int u, int v, SkPath *)

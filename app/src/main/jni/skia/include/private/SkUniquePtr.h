...
namespace skstd {
    ...
    class unique_ptr {
        ...
        struct pointer_type_detector {
            template<typename U>
            static typename U::pointer detector(typename U::pointer *);
    ...
    private:
        ...
        template<typename B>
        struct compressed_base<B, false> {
            B fb;
    ...
    public:
        ...
        unique_ptr(
        unique_ptr<U, ThatD> &&that
        ) /*noexcept*/
        :
        data(that
        .

        release(), forward<ThatD>(that
        ...
        template<typename U, typename ThatD>
        enable_if_t<
                is_convertible<typename unique_ptr<U, ThatD>::pointer, pointer>::value &&
                !is_array<U>::value,
